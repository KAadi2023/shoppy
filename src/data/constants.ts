export const PRODUCTS_LIST: Product[] = [
    ...
    },
    {
      ...
      rating: 4.7,
      ratingCount: 8794,
      tags: ['12MP Dual Rear Camera', '15.49 cm Super Retina XDR Display', 'A15 Bionic Chip, 6 Core Processor Processor'],
    },
    {
      id: '4',
    ...
    {
      id: '5',
      name: 'APPLE iPhone 13 (White, 64 GB)',
      imageUrl:
        'https://rukminim1.flixcart.com/image/300/400/k2jbyq80pkrrdj/mobile-refurbished/k/y/d/iphone-11-256-u-mwm82hn-a-apple-0-original-imafkg25mhaztxns.jpeg',
      originalPrice: 43900,
      discountPrice: 38999,
      ...
      tags: [
        '12MP Front Camera',
        '12MP Dual Rear Camera',
        '14.49 cm (5.7 inch) Super Retina XDR Display',
      ],
    },
  ];
